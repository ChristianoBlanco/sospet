...
<div class="box content">
    <h1 style="font-size: 20px; font-weight: 900; color:#000000; margin-bottom:50px;"><?= 'Atualizar Senha'; ?></h1>
    ...
    <form action="{{url('/usuarios-senha')}}{{'/'}}{{Auth::user()->id}}" method="POST" style="margin-top: 20px; font-size:15px;">
        ...
        <div class="col-md-6" style="padding-right:10px;  margin-top:5px;">
            ...
            <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" placeholder="Senha"  autocomplete="new-password" required>
        </div>
