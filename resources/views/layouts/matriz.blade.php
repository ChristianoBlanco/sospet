...
<!--Confirma��es de a��es de but�es, links.... -->
...
<!-- <li class="ttr_menu_items_parent dropdown"><a href="#" class="ttr_menu_items_parent_link"><span class="menuchildicon"></span><?//php echo utf8_encode('Servi�os'); ?></a>
<hr class ="horiz_separator"/>  -->
</li>
...
<!-- <li class="ttr_menu_items_parent dropdown"><a href="#login-form" class="ttr_menu_items_parent_link"><span class="menuchildicon"></span><?php  //echo utf8_encode('Login do usu�rio'); ?> </a> -->
    @auth
      <hr class ="horiz_separator"/>
    @endauth
